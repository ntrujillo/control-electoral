(function (angular) {
    ...
    angular.module('ControlElectoralApp').factory('Filtros', ['$resource', function ($resource) {
        ...
        service.Zona = $resource('/api/parroquia/:id_parroquia/zona/:id', {query: {method: "GET", isArray: true}});
        service.Recinto = $resource('/api/zona/:id_zona/recinto/:id', {query: {method: "GET", isArray: true}});
